...
python train_models.py --feature_dim 4096 --feature_type DS_VGG --max_sequence_length 9000 --modality vision --learning_rate 0.0001 --logger_name DS_VGG.log
python train_models.py --feature_dim 1920 --feature_type DS_densenet --max_sequence_length 18000 --modality vision --learning_rate 0.0005 --logger_name DS_densenet.log
